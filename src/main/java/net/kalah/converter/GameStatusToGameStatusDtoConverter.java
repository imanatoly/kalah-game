...
import static net.kalah.dto.GameStatusDto.YOUR_TURN;
...
public class GameStatusToGameStatusDtoConverter {
    ...
    public GameStatusDto convert(GameStatus gameStatus, Player player){
        ...
        switch (gameStatus){
            case CREATED:
            case WAITING_OPPONENT: return WAITING_OPPONENT;
            case TURN_A: return (player==A) ? YOUR_TURN : OPPONENT_TURN;
            case TURN_B: return (player==A) ? OPPONENT_TURN : YOUR_TURN;
